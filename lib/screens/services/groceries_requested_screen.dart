...
/// The confirmation screen displayed after a resident submits a Groceries request.
class GroceriesRequestedScreen extends StatelessWidget {
  final GroceryRequest request;

  const GroceriesRequestedScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const AppHeader(
        ...
        subtitle: AppStrings.groceriesRequestReceivedSubtitle,
