...
/// The confirmation screen displayed after a resident submits a Cooking Gas request.
class GasRequestedScreen extends StatelessWidget {
  final GasRequest request;

  const GasRequestedScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: const AppHeader(
        ...
        subtitle: AppStrings.gasRequestReceivedSubtitle,
