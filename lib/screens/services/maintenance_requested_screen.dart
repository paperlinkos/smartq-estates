...
/// The confirmation screen displayed after a resident submits a Maintenance request.
class MaintenanceRequestedScreen extends StatelessWidget {
  final MaintenanceRequest request;

  const MaintenanceRequestedScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    final hasCategory =
        request.category != null && request.category!.trim().isNotEmpty;
    ...
    return Scaffold(
      ...
      appBar: const AppHeader(
        ...
        subtitle: AppStrings.maintenanceRequestReceivedSubtitle,
            ...
            children: [
              ...
              AppCard(
                ...
                child: Column(
                  ...
                  children: [
                    // WHAT NEEDS FIXING
                    _buildSectionHeader(AppStrings.labelDescriptionSummary),
                    ...
                    if (hasCategory) ...[
                      ...
                      // CATEGORY
                      _buildSectionHeader(AppStrings.labelCategorySummary),
                      const SizedBox(height: 6),
                      Text(
                        request.category!,
                        style: const TextStyle(
