...
/// The screen allowing residents to submit a Groceries delivery request.
...
class _GroceriesScreenState extends State<GroceriesScreen> {
  ...
  GroceryTiming _selectedTiming = GroceryTiming.asSoonAsPossible;
  ...
  GroceryRepository get _repo =>
      widget.repository ?? LocalGroceryRepository.instance;
  ...
  void _submit() {
    ...
    if (_selectedTiming == GroceryTiming.scheduled) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppHeader(
        ...
        subtitle: AppStrings.groceriesHeaderSubtitle,
        showBackButton: true,
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                AppStrings.groceriesQuestionSubtitle,
                style: TextStyle(
              ...
              AppTextField(
                ...
                hintText: AppStrings.hintGroceriesItems,
              ...
              AppTextField(
                ...
                hintText: AppStrings.hintGroceriesNotes,
                minLines: 2,
                maxLines: 4,
                textCapitalization: TextCapitalization.sentences,
              ),
              ...
              // ── Submit Action ─────────────────────────────────────────
              AppButton(
                text: AppStrings.actionRequestGroceries,
                onPressed: _submit,
              ),
